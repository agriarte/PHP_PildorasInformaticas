...
<html>
    ...
    <body>
        <h2>Nueva entrada</h2>
        <form action="../36controlador/36transacciones.php" method="post" enctype="multipart/form-data" name="form1">
            <table >
                <tr>
                    <td>Título: 
                ...
                <tr><td colspan="2" align="center"><a href="36indexMostrarBlog.php">Página de visualización del blog</a></td></tr>
